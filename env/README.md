...
Secrets for `agent-pontifex/ai-agent-bridge.rs` are **committed, encrypted**, with [sops] + [age],
...
```sh
just env-docker-run dev ghcr.io/agent-pontifex/ai-agent-bridge.rs:dev
